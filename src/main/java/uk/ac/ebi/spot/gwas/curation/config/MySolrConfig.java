...
@Configuration
@ConditionalOnProperty(name = "gwas-curation.solr.enabled", havingValue = "true")
@EnableSolrRepositories(value = "uk.ac.ebi.spot.gwas.curation.solr", schemaCreationSupport = true)
@ComponentScan

...
public interface StudySolrRepository extends SolrCrudRepository<StudySolr, String> {
    ...
    @Query("efoTraits:*?0*")
    public Page<StudySolr> findByEfoTraitsWithoutSpaces(String efoTrait, Pageable page);
    ...
    @Query("reportedTrait:*?0*")
    public Page<StudySolr> findByReportedTraitWithoutSpaces(String reportedTrait, Pageable page);

    @Query(value = "notes:\"*?0*\"")
    public Page<StudySolr> findByNotes(String notes, Pageable page);

    @Query(value = "notes:*?0*")
    public Page<StudySolr> findByNotesWithoutSpaces(String notes, Pageable page);

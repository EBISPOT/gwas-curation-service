...
public interface StudySolrRepository extends SolrCrudRepository<StudySolr, String> {
    ...
    @Query("efoTraits:?0 AND reportedTrait:?1 AND notes:?2 AND sumstatsFlag:?3 OR gxeFlag:?4 OR pooledFlag:?5")
    ...
    @Query("efoTraits:?0 AND reportedTrait:?1 AND notes:?2 AND sumstatsFlag:?3 OR gxeFlag:?4")
    ...
    @Query("efoTraits:?0 AND reportedTrait:?1 AND notes:?2 AND pooledFlag:?3 OR gxeFlag:?4")
    ...
    @Query("efoTraits:?0 AND reportedTrait:?1 AND notes:?2 AND sumstatsFlag:?3 OR pooledFlag:?4")
    ...
    @Query("efoTraits:?0 AND reportedTrait:?1 AND notes:?2 AND sumstatsFlag:?3")
    public Page<StudySolr> findByEfoTraitsAndReportedTraitAndNotesAndSumstatsFlag
            (String efoTrait, String reportedTrait, String notes,
             boolean sumstatsFlag, Pageable page);

    @Query("efoTraits:?0 AND reportedTrait:?1 AND notes:?2 AND pooledFlag:?3")
    public Page<StudySolr> findByEfoTraitsAndReportedTraitAndNotesAndPooledFlag
            (String efoTrait, String reportedTrait, String notes,
             boolean pooledFlag, Pageable page);

    @Query("efoTraits:?0 AND reportedTrait:?1 AND sumstatsFlag:?2 OR gxeFlag:?3 OR pooledFlag:?4")
    ...
    @Query("efoTraits:?0 AND reportedTrait:?1 AND sumstatsFlag:?2 OR gxeFlag:?3")
    public Page<StudySolr> findByEfoTraitsAndReportedTraitAndSumstatsFlagOrGxeFlag
            (String efoTrait, String reportedTrait, boolean sumstatsFlag,
             boolean gxeFlag, Pageable page);

    @Query("efoTraits:?0 AND reportedTrait:?1 AND pooledFlag:?2 OR gxeFlag:?3")
    ...
    @Query("efoTraits:?0 AND notes:?1 AND sumstatsFlag:?2 OR gxeFlag:?3 OR pooledFlag:?4")
    ...
    @Query("reportedTrait:?0 AND notes:?1 AND sumstatsFlag:?2 OR gxeFlag:?3")
    public Page<StudySolr> findByReportedTraitAndNotesAndSumstatsFlagOrGxeFlag
            (String reportedTrait , String notes, boolean sumstatsFlag,
             boolean gxeFlag, Pageable page);

    @Query("reportedTrait:?0 AND notes:?1 AND sumstatsFlag:?2 OR pooledFlag:?3")
    public Page<StudySolr> findByReportedTraitAndNotesAndSumstatsFlagOrPooledFlag
            (String reportedTrait , String notes, boolean sumstatsFlag,
             boolean pooledFlag, Pageable page);

    @Query("reportedTrait:?0 AND notes:?1 AND pooledFlag:?2 OR gxeFlag:?3")
    ...
    @Query("efoTraits:?0 AND reportedTrait:?1")

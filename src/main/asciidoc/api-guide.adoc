...
The response is <<overview-pagination,paginated>> where the individual <<resources-studies,studies resources>>  are in the `_embedded.studies` field.
...
The EFO Traits resources is used to list EFO traits in the GWAS Catalog
